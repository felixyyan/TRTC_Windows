...
namespace TRTCWPFDemo 
{
    class GenerateTestUserSig
    {
        ...
        public static readonly AppInfo[] APPS = new AppInfo[]
        {
            new AppInfo { SdkAppId = 0, SecretKey = @"" },
        };
        ...
        /// </summary>
        public const int APPID = 1252463788;
        public const int BIZID = 3891;
        ...
        /// </remarks>
        public string GenTestUserSig(int sdkAppId, string userId)
        {
            string secretKey = "";
